...
export function Singup() {
    ...
    return (
        <>
        <Header></Header>
            <section className="h-100" style={{ "backgroundColor": "#9A616D", "width": "80%", "margin": "auto" }}>
                                    ...
                                    <div className="col-xl-6">
                                        <div className="card-body p-md-5 text-black">
                                            ...
                                            <div style={{"display" : "flex"}}>
                                                    ...
                                                    <h3 className="fw-normal mb-3 pb-3" style={{ "letterSpacing": "1px", "marginLeft" : "100px", "marginTop" : "35px" }}>הרשמה לאתר</h3>
                                                    </div>
                                                ...
                                                <div className="form-outline mb-4">
                                                    <label className="form-label" for="form3Example1m">שם החנות</label>
                                                    <input id="form3Example1m" className="form-control"
                                                        type="text"
                                                        name="storeName"
                                                        {...register('storeName')}
                                                ...
                                                <div style={{ 'borderTop': '1px solid black', 'padding': '15px' }}>
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6 mb-4">
                                                            <label className="form-label" for="form3Example1m">רחוב</label>
                                                            <input id="form3Example1m" className="form-control"
                                                                type="text"
                                                                name="street"
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6 mb-4">
                                                            <label className="form-label" for="form3Example1m">מספר בית</label>
                                                        ...
                                                        <div className="col-md-6 mb-4">
                                                            <label className="form-label" for="form3Example1m">קומה</label>
                                                            <input id="form3Example1m" className="form-control"
                                                                type="number"
                                                                name="floor"
