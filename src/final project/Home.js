...

            {
                ...
                <>
                    <div className="card" style={{ margin: "120px" }}>
                        <div className="row" style={{ "textAlign": "center", border: "2px solid black", borderRadius: "5px", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }}>
                            <div className="col-6" id="backColorForm" style={{ "textAlign": "center" }}>
                                {
                                    navToUpdate == false &&
                                    <>
                                        <button type="button" 
                            ...
                            <div className="col-6" id="backColor" style={{ "textAlign": "center" }}>
                                <div className="card-body" style={{ margin: "20px" }}>
                                    ...
                                    <i><h5 className="card-text">{details.storeName}</h5></i>
                                    <br></br>
                                    <br></br>
                                    <br></br>
                                </div>
