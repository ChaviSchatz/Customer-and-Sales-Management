...
public class DBConnection : IDBConnection
{
    ...
    public string TokensCollectionName { get; set; } = "tokens";
    ...
    public IMongoCollection<UserRefreshToken> TokensCollection { get; private set; }
    ...
    public DBConnection(IConfiguration config)
    {
        ...
        TokensCollection = _db.GetCollection<UserRefreshToken>(TokensCollectionName);
    }
